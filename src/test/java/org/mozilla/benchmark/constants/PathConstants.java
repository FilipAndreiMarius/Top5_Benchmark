...
public final class PathConstants {
    ...
    private static final String AMAZON_HEADER = "amazon_header.png";
    private static final String AMAZON_HEADER_BACKGROUND = "header_background.png" +
            "";
    ...
    public static final String FIRST_NON_BLANK_AMAZON = RESOURCES_PATH + File.separator + AMAZON_HEADER;
    public static final String HEADER_BACKGROUND_AMAZON = RESOURCES_PATH + File.separator + AMAZON_HEADER_BACKGROUND;
