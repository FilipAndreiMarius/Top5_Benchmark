...
import PageLoadFlows.GmailPage;
...
import static Constants.Object_Constants.IMAGES_NON_BLANK;
import static Constants.Object_Constants.LAST_HERO;

/**
 * Created by andrei.filip on 10/4/2017.
 */
public class Gmail extends ImageSearch{
    ...
    public static void main(String args[]) throws IOException {
       /*Thread recordVideo = new VideoCapture("20", "70", "runVideo", ObjectTypes.GMAIL.name);
        recordVideo.start();
*/
        Thread a = new GmailPage(1);
        a.start();
       ...
       /*try {
        ...
        Thread compress =new VideoCapture("compress",ObjectTypes.GMAIL.name);
        compress.start();
        ...
        Thread splitVideo =new VideoCapture("splitVideo",ObjectTypes.GMAIL.name);
        splitVideo.start();*/


        /*Gmail gm = new Gmail();
        gm.getFirstNonBlankHero();*/
    }
